...
# from src.discover_routes import (
#     get_fill_routes,
#     get_token_info,
...
#     with (
#         patch("src.discover_routes.CHAINS", [mock_chain_data]),
#         patch("src.discover_routes.Web3") as mock_web3,
#         patch("src.discover_routes.SPOKE_POOL_ABI", [{"some": "abi"}]),
#         patch("src.discover_routes.contracts", {}),
#     ):
#         # Create mock objects
#         mock_eth = MagicMock()
...
#         patch("src.discover_routes.CHAINS", [mock_chain_data]),
#         patch("src.discover_routes.Web3") as mock_web3,
#         patch("src.discover_routes.ERC20_ABI", [{"some": "abi"}]),
#     ):
...
#     with (
#         patch("src.discover_routes.CHAINS", [mock_chain_data]),
#         patch("src.discover_routes.requests.get") as mock_get,
#         patch("src.discover_routes.contracts") as mock_contracts,
#     ):
...
#     with (
#         patch("src.discover_routes.CHAINS", []),
#         patch("src.discover_routes.Web3") as mock_web3,
#     ):
...
#     with (
#         patch("src.discover_routes.CHAINS", [mock_chain]),
#         patch("src.discover_routes.SPOKE_POOL_ABI", [{"some": "abi"}]),
#         patch("src.discover_routes.Web3") as mock_web3,
#     ):
#         mock_web3.HTTPProvider.side_effect = Exception("Connection error")
...
#     with patch(
#         "src.discover_routes.get_db_connection",
